...
export default function EventArchives({ data }) {
  ...
  return (
    <Section>
      <StyledSection>
      <SectionTitle style={{color: "white"}}>Elyseos Events</SectionTitle>
      <Subtitle>All current events</Subtitle>
      <IntroContainer>
        ...
        <PostsContainer>
        {data.allContentfulEventsPage.edges.map(post => {
